    ...
    return (
        <TouchableOpacity
            ...
            style={styles.touchItem}>
            {
                item.type === 'text' ?
                    (
                        <Text style={item.text.style ? item.text.style : styles.textItem}>{item.text.name}</Text>
                    )
                    : item.type === 'image' ?
                        (
                            <Image
            ...
            <View
                ...
                <View style={styles.header}>
                    ...
                    <View style={[styles.viewItem, { justifyContent: 'flex-start', }]}>
                        {!arrayIsEmpty(itemLeft) && itemLeft.map((value, index) => {
                            return (
                    ...
                    <View style={[styles.viewItem, { justifyContent: 'flex-end' }]}>
                        {!arrayIsEmpty(itemRight) && itemRight.map((value, index) => {
                            return (
                                renderItem(value, index, count)
                            )
                        })}
                    </View>
